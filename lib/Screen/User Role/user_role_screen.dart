                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Container(
                              height:
                              (MediaQuery.of(context).size.height - 150).isNegative ? 0 : MediaQuery.of(context).size.height - 150,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    decoration:  BoxDecoration(color: kLitGreyColor.withOpacity(0.2)),
                                    child: const Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: 210, child: Text('Shop Name')),
                                          SizedBox(width: 180, child: Text('Category')),
                                          SizedBox(width: 180, child: Text('Phone')),
                                          SizedBox(width: 200, child: Text('Email')),
                                          SizedBox(width: 50, child: Text('No. of Role')),
                                        ],
                                      ),
                                    ),
                                  ),
                                            ...
                                            title: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(width: 210, child: Text(mainShowList[index].sellerInfoModel.companyName.toString())),
                                                  SizedBox(width: 180, child: Text(mainShowList[index].sellerInfoModel.businessCategory.toString())),
                                                  SizedBox(width: 180, child: Text(mainShowList[index].sellerInfoModel.phoneNumber.toString())),
                                            ...
                                            children: List.generate(
                                              ...
                                              (i) => Padding(
                                                ...
                                                child: Row(
                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                  children: [
                                                    SizedBox(width: 50, child: Text((i + 1).toString(),style: kTextStyle.copyWith(color: kTitleColor),)),
                                                    SizedBox(width: 210, child: Text(mainShowList[index].userRoles[i].userTitle.toString(),style: kTextStyle.copyWith(overflow: TextOverflow.ellipsis,color: kTitleColor))),
                                                    SizedBox(width: 180, child: Text(mainShowList[index].sellerInfoModel.businessCategory.toString(),style: kTextStyle.copyWith(overflow: TextOverflow.ellipsis,color: kTitleColor))),
                                                    SizedBox(width: 180, child: Text(mainShowList[index].sellerInfoModel.phoneNumber.toString(),style: kTextStyle.copyWith(overflow: TextOverflow.ellipsis,color: kTitleColor))),
                                                    SizedBox(width: 200, child: Text(mainShowList[index].userRoles[i].email.toString(),style: kTextStyle.copyWith(overflow: TextOverflow.ellipsis,color: kTitleColor),)),
