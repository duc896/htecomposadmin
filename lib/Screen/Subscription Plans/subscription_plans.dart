                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  onTap: (){
                                    selectedOne.subscriptionName == 'Free' || selectedOne.subscriptionName == 'Monthly' || selectedOne.subscriptionName == 'Yearly' ?
                                    EasyLoading.showInfo('Can\'t change for Free/Monthly/Yearly') : null;
                                  },


                                  initialValue: selectedOne.subscriptionName,
                                  readOnly: selectedOne.subscriptionName == 'Free' || selectedOne.subscriptionName == 'Monthly' || selectedOne.subscriptionName == 'Yearly' ? true : false,
                                  decoration: const InputDecoration(
                                    floatingLabelBehavior: FloatingLabelBehavior.always,
                                    border: OutlineInputBorder(),
                                    labelText: 'Plan Name',
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    ).visible(data[index].subscriptionName != 'Free' && data[index].subscriptionName != 'Monthly' && data[index].subscriptionName != 'Yearly'),
                                                  ],
                                                ),
                                              )
                                            ],
